...
You can also specify the :lock=>true option, in which case a Mutex object will
be used to guard access to the callback.  This Mutex is created the first time
